...
class AdminController extends Controller
{
    ...
    public function add(Request $req)
    {
        ...
        if (Admin::where('name', $req->name)->orWhere('mobile', $req->mobile)->count()) {
    ...
    public function update(Request $req)
    {
        ...
        if (Admin::where(function ($query) use ($req) {
            $query->where('name', $req->name)->orWhere('mobile', $req->mobile);
    ...
    public function detail(Request $req)
    {
        ...
        $data = Admin::select('id', 'group_id', 'status', 'mobile')->find($req->admin_id);
